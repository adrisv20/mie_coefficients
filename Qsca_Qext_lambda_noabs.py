...
#de onda lambda con un core-shell quiral y sin absorción (eh es real).
...
fig.suptitle("$Q_{s}$ y $Q_{ext}$ vs $\\lambda[nm]$ ($\\sigma=-1$, $\\kappa=1$ y núcleo sin absorción)", fontsize=14)
