...
#quiralidad kappa con un core-shell quiral y con absorción (eh es complejo).
...
fig.suptitle("$Q_{s}$ y $Q_{ext}$ vs $\\kappa$ ($\\sigma=1$, $\\lambda=1064$ nm y núcleo con absorción)", fontsize=14)
